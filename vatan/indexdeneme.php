...
$i = 0;
$sutun = 3;
$sql=mysql_query("select * from urunler order by one_cikan_urun DESC LIMIT 9");

?>
      <table width="701" height="135" border="1">
        <tr>
<?php
while($veri = mysql_fetch_assoc($sql)){ 
  ...
  ?>
          <td width="407" valign="top"><table width="223" border="1" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center"><img src="urunicerik/foto/<?php echo $veri['urun_menu_kategori'].'/'.$veri['foto_yol']; ?>" height="105" width="105"/></td>
            </tr>
            <tr>
              <td align="center"><?=$veri['urun_adi'];?></td>
            </tr>
            <tr>
              <td align="center"><?=$veri['urun_fiyati'];?></td>
            </tr>
          </table></td>
<?php 
if ($i % $sutun == 0) 
