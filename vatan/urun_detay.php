...
<div id="ust">
  ...
  while($dr = mysql_fetch_array($sorgu)){
    ...
    ?>
      <div id="apDiv2" align="center"> <h2><center>ÜRÜN ÖZELLİKLERİ</center></h2>
 <?php echo $dr['urun_ozellikleri']; ?></div>
      <div id="apDiv4" align="center"> <h2><center>ÜRÜN ADI</center></h2>
 <?php echo $dr['urun_adi']; ?></div>
      <div id="apDiv5" align="center"> <h2><center>ÜRÜN FİYATI</center></h2>
 <?php echo $dr['urun_fiyati']; ?></div>
      <div id="apDiv6"><img src="urunicerik/foto/<?php echo $dr['urun_menu_kategori'].'/'.$dr['foto_yol'];?>" width="300" height="350" /></div>
      <div id="apDiv7"><h2><center>ÜRÜN YORUMLARI</center></h2>
