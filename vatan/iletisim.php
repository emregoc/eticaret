...
<div id="ust">
  ...
  <table width="790" height="100" border="0">
    <tr>
      ...
      <td height="52" colspan="2"><table width="298" border="0" align="right">
        <tr>
          ...
          <td width="138"><a href="iletisim.php" class="kopru">İletişim </a>|<a href="uyekayit.php" class="kopru"> Üye Ol</a></td>
        </tr>
      </table>
        <br /></td>
    </tr>
    <tr>
      ...
      <td width="210" align="left">SEPETİM(0 ÜRÜN) | <a href="uye_giris.php" class="kopru"> Giriş Yap</a></td>
    </tr>
  </table>
</div>
<div id="ustcizgi"></div>
<div id="govde">
  ...
  <div id="icerik">
    <h1>İletişim <br />
      <br />
      <span id="font">0850 222 56 56 - Vatan Computer Telefon ile Sipariş Hattı Hafta içi ve hafta sonu saat 09:00 ile 22:00 arasında siz değerli müşterilerimize kaliteli ve kesintisiz destek vermektedir.<br />
        0850 222 56 56 – Vatan Computer Çağrı Merkezi Satış sonrası destek Hafta içi saat 09.00 – 18.30, hafta sonu 09.00 - 16:00 (Pazar günü hariç) arasında siz değerli müşterilerimize kaliteli ve kesintisiz destek vermektedir.<br />
        <br />
        Arızalı ürünlerinizin durumu hakkında bilgi alabilirsiniz. İnternet Satış (İnternet siparişleriniz ile ilgili) Hafta içi saat 09.00 – 18.30, hafta sonu 10.00 – 17.00 arasında siz değerli müşterilerimize kaliteli ve kesintisiz destek vermektedir. İnternet siparişlerinizin durumu hakkında bilgi alabilirsiniz.<br />
        <br />
        <br />
        Kayıtlı Elektronik Posta (KEP) <br />
        Adresimiz: vatanbilgisayar@hs01.kep.tr <br />
        Mersis numarası: 0-6320-0360-720001 <br />
        Kayıtlı Bulunduğumuz Meslek Kuruluşu: İstanbul Ticaret Odası (www.ito.org.tr) </span></h1>
  </div>
</div>
</div>
<div id="footer2"></div>
