...
<div id="ust">
  ...
  <table width="790" height="100" border="0">
    ...
    <tr>
      ...
      <td width="210" align="left">SEPETİM(0 ÜRÜN) | <a href="uye_giris.php" class="kopru1"> Giriş Yap</a></td>
    </tr>
  </table>
</div>
<div id="ustcizgi"></div>
...
<table width="579" height="452" border="1" align="center">
  ...
  ?>
            <a href="urun_detaykopya.php?urun_id=<?php echo $dr['urun_id']; ?>">&nbsp;&nbsp;&nbsp;<img src="urunicerik/foto/<?php echo $dr['urun_menu_kategori'].'/'.$dr['foto_yol'];?>" width="50" height="50" /> </a> <a href="urun_detaykopya.php?urun_id=<?php echo $dr['urun_id']; ?>"><?php echo $dr['urun_alt_kategori']; ?></a>
          <?php }?></td>
          <td width="127">
		  <?php
