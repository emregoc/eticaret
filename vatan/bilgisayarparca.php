...
$i = 0;
$sutun = 5;
$sql=mysqli_query($baglan1,"select * from urunler where urun_menu_kategori='bilgisayarparca'");
...
while($veri = mysqli_fetch_assoc($sql)){ 
  ...
  ?>
          <td width="300" valign="top"><table width="150" height="100" border="1" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center"><a href="urun_detaykopya.php?urun_id=<?=$veri['urun_id'];?>"><img src="urunicerik/foto/<?php echo $veri['urun_menu_kategori'].'/'.$veri['foto_yol']; ?>" height="70" width="70"/></a></td>
            </tr>
            <tr>
