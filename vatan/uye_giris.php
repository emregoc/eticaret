...
<body>
<div id="ust">
  <div id="logo"><a href="index.php"><img src="image/logo.png" alt="" width="210" height="100" border="0" align="baseline" usemap="#Map" /></a>
    <map name="Map" id="Map">
      <area shape="rect" coords="2,2,208,99" href="index.php" />
    </map>
  </div>
